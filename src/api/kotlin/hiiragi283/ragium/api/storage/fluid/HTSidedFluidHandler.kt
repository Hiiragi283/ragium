...
interface HTSidedFluidHandler : HTExtendedFluidHandler {
    ...
    @Deprecated("Use `getTanks(Direction?)` instead", level = DeprecationLevel.ERROR)
    override fun getTanks(): Int = getTanks(getFluidSideFor())

    fun getFluidInTank(tank: Int, side: Direction?): FluidStack

    @Deprecated("Use `getFluidInTank(Int, Direction?)` instead", level = DeprecationLevel.ERROR)
    ...
    @Deprecated("Use `getTankCapacity(Int, Direction?)` instead", level = DeprecationLevel.ERROR)
    ...
    @Deprecated("Use `insertFluid(FluidStack, Boolean, Direction?)` instead", level = DeprecationLevel.ERROR)
    ...
    @Deprecated("Use `extractFluid(FluidStack, Boolean, Direction?)` instead", level = DeprecationLevel.ERROR)
    ...
    @Deprecated("Use `isFluidValid(Int, FluidStack, Direction?)` instead", level = DeprecationLevel.ERROR)
    ...
    @Deprecated("Use `extractFluid(Int, Boolean, Direction?)` instead", level = DeprecationLevel.ERROR)
