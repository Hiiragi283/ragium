...
fun HTItemSlot.getCapacityAsLong(stack: ItemStack): Long = this.getCapacityAsLong(ImmutableItemStack.of(stack))

fun HTItemSlot.getCapacityAsInt(stack: ItemStack): Int = this.getCapacityAsInt(ImmutableItemStack.of(stack))

fun HTItemSlot.isValid(stack: ItemStack): Boolean = this.isValid(ImmutableItemStack.of(stack))

fun HTItemSlot.insertItem(stack: ItemStack, action: HTStorageAction, access: HTStorageAccess): ItemStack =
    this.insert(ImmutableItemStack.of(stack), action, access).stack
...
fun HTItemSlot.Mutable.setItemStack(stack: ItemStack) {
    setStack(ImmutableItemStack.of(stack))
}
