...
object CommonMaterials {
    ...
    @JvmField
    val BERYLLIUM: HTMaterialKey = HTMaterialKey.of("beryllium")
    ...
    @JvmField
    val NIOBIUM: HTMaterialKey = HTMaterialKey.of("niobium")
    ...
    @JvmField
    val SOLDERING_ALLOY: HTMaterialKey = HTMaterialKey.of("soldering_alloy")

    @JvmField
    val STAINLESS_STEEL: HTMaterialKey = HTMaterialKey.of("stainless_steel")
