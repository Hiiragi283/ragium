 ...
 * 素材の種類を管理するキー
 */
class HTMaterialKey private constructor(val materialName: String) : Comparable<HTMaterialKey> {
    companion object {
    ...
    override fun equals(other: Any?): Boolean = (other as? HTMaterialKey)?.materialName == materialName
