...
class HTFluidOutputRecipeBuilder<T : HTFluidOutputRecipe>(
    ...
    companion object {
        @JvmStatic
        fun extractor(lookup: HolderGetter<Item>): HTFluidOutputRecipeBuilder<HTExtractorRecipe> = HTFluidOutputRecipeBuilder(lookup) {
            group: String,
        ...
        @JvmStatic
        fun infuser(lookup: HolderGetter<Item>): HTFluidOutputRecipeBuilder<HTInfuserRecipe> = HTFluidOutputRecipeBuilder(lookup) {
            group: String,
            itemInputs: List<HTItemIngredient>,
            fluidInputs: List<SizedFluidIngredient>,
            itemOutputs: List<HTItemOutput>,
        ...
        @JvmStatic
        fun mixer(lookup: HolderGetter<Item>): HTFluidOutputRecipeBuilder<HTMixerRecipe> = HTFluidOutputRecipeBuilder(lookup) {
            group: String,
            itemInputs: List<HTItemIngredient>,
            fluidInputs: List<SizedFluidIngredient>,
            itemOutputs: List<HTItemOutput>,
        ...
        @JvmStatic
        fun refinery(lookup: HolderGetter<Item>): HTFluidOutputRecipeBuilder<HTRefineryRecipe> = HTFluidOutputRecipeBuilder(lookup) {
            group: String,
            itemInputs: List<HTItemIngredient>,
            fluidInputs: List<SizedFluidIngredient>,
            itemOutputs: List<HTItemOutput>,
