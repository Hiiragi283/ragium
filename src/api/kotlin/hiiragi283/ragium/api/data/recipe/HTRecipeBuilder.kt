...
interface HTRecipeBuilder : RecipeBuilder {
    ...
    override fun unlockedBy(name: String, criterion: Criterion<*>): RecipeBuilder = unsupported()

    /**
     * レシピIDの生成は[getPrimalId]を介して行われます。
     */
    @Deprecated(message = "Recipe ID is generated by `getPrimalId()`", level = DeprecationLevel.ERROR)
    override fun getResult(): Item = unsupported()
    ...
    override fun save(recipeOutput: RecipeOutput, id: String): Unit = unsupported()
    ...
    abstract class Prefixed(val prefix: String) : HTRecipeBuilder {
        ...
        override fun group(groupName: String?): RecipeBuilder = unsupported()
