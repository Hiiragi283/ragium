...
class HTEnchantingRecipe(ingredients: List<HTItemIngredient>, result: HTEnchantedBookResult) :
    HTCombineItemToItemRecipe<HTEnchantedBookResult>(ingredients, result) {
