...
abstract class HTCombineItemToObjRecipe<R : HTRecipeResult<ItemStack>>(val ingredients: List<HTItemIngredient>, val result: R) :
    HTMultiItemToItemRecipe {
    final override fun test(input: HTMultiItemRecipeInput): Boolean = HTMultiItemToItemRecipe.hasMatchingSlots(ingredients, input.items)
