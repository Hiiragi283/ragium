...
/**
 * [HTRuntimeRecipeProvider]に基づいたレシピ向けのマネージャ
 * @see RagiumPlatform.getMaterialRecipeManager
 */
interface HTRuntimeRecipeManager {
    /**
     * 指定した[recipeType]に対応するすべてのレシピを返します。
     * @param RECIPE レシピのクラス
     * @return [RecipeHolder]の[List]
     */
    fun <RECIPE : Recipe<*>> getAllRecipes(recipeManager: RecipeManager, recipeType: RecipeType<RECIPE>): List<RecipeHolder<RECIPE>>
