...
interface HTItemToFluidRecipe :
    ...
    open class Basic(val ingredient: HTItemIngredient, val result: HTFluidResult, override val progressData: HTProgressData) :
        ...
        companion object {
            @JvmStatic
            fun <RECIPE : Basic> codec(factory: HTItemToFluidRecipeBuilder.Factory<RECIPE>) = HTCodecs.recordMap { instance ->
                instance.group(
            ...
            @JvmStatic
            fun <RECIPE : Basic> streamCodec(factory: HTItemToFluidRecipeBuilder.Factory<RECIPE>): StreamCodec<RegistryFriendlyByteBuf, RECIPE> = StreamCodec.composite(
