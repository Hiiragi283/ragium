...
class RTPlantingRecipe(ingredient: HTItemIngredient, primary: HTItemResult, secondary: Optional<HTItemResult>, progressData: HTProgressData) :
    HTItemToDoubleItemRecipe.Basic(ingredient, primary, secondary, progressData),
    HTSerializableRecipe<SingleRecipeInput> {
    companion object {
        @JvmField
        val SERIALIZER: RecipeSerializer<RTPlantingRecipe> = RecipeSerializer(codec(::RTPlantingRecipe), streamCodec(::RTPlantingRecipe))
    }
