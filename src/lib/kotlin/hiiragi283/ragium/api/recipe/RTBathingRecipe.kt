...
class RTBathingRecipe(itemIngredient: HTCatalystOrIngredient, fluidIngredient: HTFluidIngredient, result: HTItemResult, progressData: HTProgressData) :
    ...
    companion object {
        @JvmField
        val SERIALIZER: RecipeSerializer<RTBathingRecipe> = RecipeSerializer(codec(::RTBathingRecipe), streamCodec(::RTBathingRecipe))
    }
