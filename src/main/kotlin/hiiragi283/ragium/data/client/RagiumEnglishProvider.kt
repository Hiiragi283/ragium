...
class RagiumEnglishProvider(output: PackOutput) : LanguageProvider(output, RagiumAPI.MOD_ID, "en_us") {
    override fun addTranslations() {
        ...
        add(RagiumItems.CHEMICAL_MACHINE_CASING, "Chemical Machine Casing")
        ...
        add(RagiumItems.MACHINE_CASING, "Machine Casing")
        ...
        add(RagiumItems.PRECISION_MACHINE_CASING, "Precision Machine Casing")
