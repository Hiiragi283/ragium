...
object RagiumLangProviders {
    ...
    private class EnglishLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            builder.add(RagiumBlocksNew.MUTATED_SOIL, "Mutated Soil")
            builder.add(RagiumBlocksNew.POROUS_NETHERRACK, "Porous Netherrack")
            ...
            builder.add(RagiumBlocksNew.SPONGE_CAKE, "Sponge Cake")
            builder.add(RagiumBlocksNew.SWEET_BERRIES_CAKE, "Sweet Berries Cake")

            builder.add(RagiumBlocks.AUTO_ILLUMINATOR, "Auto Illuminator")
            builder.add(RagiumBlocksNew.BACKPACK_INTERFACE, "Backpack Interface")
            builder.add(RagiumBlocksNew.ENCHANTMENT_BOOKSHELF, "Enchantment Bookshelf")
            builder.add(RagiumBlocksNew.ITEM_DISPLAY, "Item Display")
            ...
            builder.add(RagiumBlocksNew.ROPE, "Rope")
            builder.add(RagiumBlocksNew.SHAFT, "Shaft")
    ...
    private class JapaneseLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            builder.add(RagiumBlocksNew.MUTATED_SOIL, "変異した土壌")
            builder.add(RagiumBlocksNew.POROUS_NETHERRACK, "多孔質ネザーラック")
            ...
            builder.add(RagiumBlocksNew.SPONGE_CAKE, "スポンジケーキ")
            builder.add(RagiumBlocksNew.SWEET_BERRIES_CAKE, "スイートベリーケーキ")

            builder.add(RagiumBlocks.AUTO_ILLUMINATOR, "光源置き太郎")
            builder.add(RagiumBlocksNew.BACKPACK_INTERFACE, "バックパックインターフェース")
            builder.add(RagiumBlocksNew.ENCHANTMENT_BOOKSHELF, "エンチャント本棚")
            builder.add(RagiumBlocksNew.ITEM_DISPLAY, "アイテムティスプレイ")
            ...
            builder.add(RagiumBlocksNew.ROPE, "ロープ")
            builder.add(RagiumBlocksNew.SHAFT, "シャフト")
