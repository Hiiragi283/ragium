...
object RagiumLangProviders {
    ...
    private class EnglishLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            builder.add(RagiumItemsNew.SteelArmors.BOOTS, "Steel Boots")

            builder.add(RagiumItemsNew.DeepSteelArmors.HELMET, "Deep Steel Helmet")
            builder.add(RagiumItemsNew.DeepSteelArmors.CHESTPLATE, "Deep Steel Chestplate")
            builder.add(RagiumItemsNew.DeepSteelArmors.LEGGINGS, "Deep Steel Leggings")
            builder.add(RagiumItemsNew.DeepSteelArmors.BOOTS, "Deep Steel Boots")

            builder.add(RagiumItemsNew.StellaSuits.GOGGLE, "S.T.E.L.L.A. Goggles")
            builder.add(RagiumItemsNew.StellaSuits.JACKET, "S.T.E.L.L.A. Jacket")
            builder.add(RagiumItemsNew.StellaSuits.LEGGINGS, "S.T.E.L.L.A. Leggings")
            builder.add(RagiumItemsNew.StellaSuits.BOOTS, "S.T.E.L.L.A. Boots")

            builder.add(RagiumItemsNew.SteelTools.AXE, "Steel Axe")
            builder.add(RagiumItemsNew.SteelTools.HOE, "Steel Hoe")
            builder.add(RagiumItemsNew.SteelTools.PICKAXE, "Steel Pickaxe")
            builder.add(RagiumItemsNew.SteelTools.SHOVEL, "Steel Shovel")
            builder.add(RagiumItemsNew.SteelTools.SWORD, "Steel Sword")

            builder.add(RagiumItemsNew.DeepSteelTools.AXE, "Deep Steel Axe")
            builder.add(RagiumItemsNew.DeepSteelTools.HOE, "Deep Steel Hoe")
            ...
            builder.add(RagiumItemsNew.FILLED_FLUID_CUBE, "Fluid Cube (%s)")
            builder.add(RagiumItemsNew.FLUID_FILTER, "Fluid Filter")
            builder.add(RagiumItemsNew.FORGE_HAMMER, "Forge Hammer")
            builder.add(RagiumItemsNew.GIGANT_HAMMER, "Gigant Hammer")
            builder.add(RagiumItemsNew.GUIDE_BOOK, "Guide Book")
            builder.add(RagiumItemsNew.ITEM_FILTER, "Item Filter")
            builder.add(RagiumItemsNew.RAGI_WRENCH, "Ragi-Wrench")
            builder.add(RagiumItemsNew.RAGIUM_SABER, "Ragium Saber")
            builder.add(RagiumItemsNew.STELLA_SABER, "S.T.E.L.L.A. Saber")
            ...
            builder.add(RagiumItemsNew.CHOCOLATE_BREAD, "Chocolate Bread")
            builder.add(RagiumItemsNew.CHOCOLATE_COOKIE, "Chocolate Cookie")
            builder.add(RagiumItemsNew.COOKED_MEAT_INGOT, "Cooked Meat Ingot")
            builder.add(RagiumItemsNew.FLOUR, "Flour")
            builder.add(RagiumItemsNew.DOUGH, "Dough")
            builder.add(RagiumItemsNew.MEAT_INGOT, "Meat Ingot")
            builder.add(RagiumItemsNew.MELON_PIE, "Melon Pie")
            builder.add(RagiumItemsNew.MINCED_MEAT, "Minced Meat")
            builder.add(RagiumItemsNew.SWEET_BERRIES_CAKE_PIECE, "A piece of Sweet Berries Cake")
            ...
            builder.add(RagiumItemsNew.RAGI_TICKET, "Ragi-Ticket")

            builder.add(RagiumItemsNew.PressMolds.GEAR, "Press Mold (Gear)")
            builder.add(RagiumItemsNew.PressMolds.PIPE, "Press Mold (Pipe)")
    ...
    private class JapaneseLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            builder.add(RagiumItemsNew.SteelArmors.BOOTS, "スチールのブーツ")

            builder.add(RagiumItemsNew.DeepSteelArmors.HELMET, "深層鋼のヘルメット")
            builder.add(RagiumItemsNew.DeepSteelArmors.CHESTPLATE, "深層鋼のチェストプレート")
            builder.add(RagiumItemsNew.DeepSteelArmors.LEGGINGS, "深層鋼のレギンス")
            builder.add(RagiumItemsNew.DeepSteelArmors.BOOTS, "深層鋼のブーツ")

            builder.add(RagiumItemsNew.StellaSuits.GOGGLE, "S.T.E.L.L.A.ゴーグル")
            builder.add(RagiumItemsNew.StellaSuits.JACKET, "S.T.E.L.L.A.ジャケット")
            builder.add(RagiumItemsNew.StellaSuits.LEGGINGS, "S.T.E.L.L.A.レギンス")
            builder.add(RagiumItemsNew.StellaSuits.BOOTS, "S.T.E.L.L.A.ブーツ")

            builder.add(RagiumItemsNew.SteelTools.AXE, "スチールの斧")
            builder.add(RagiumItemsNew.SteelTools.HOE, "スチールのクワ")
            builder.add(RagiumItemsNew.SteelTools.PICKAXE, "スチールのツルハシ")
            builder.add(RagiumItemsNew.SteelTools.SHOVEL, "スチールのショベル")
            builder.add(RagiumItemsNew.SteelTools.SWORD, "スチールの剣")

            builder.add(RagiumItemsNew.DeepSteelTools.AXE, "深層鋼の斧")
            builder.add(RagiumItemsNew.DeepSteelTools.HOE, "深層鋼のクワ")
            builder.add(RagiumItemsNew.DeepSteelTools.PICKAXE, "深層鋼のツルハシ")
            builder.add(RagiumItemsNew.DeepSteelTools.SHOVEL, "深層鋼のショベル")
            builder.add(RagiumItemsNew.DeepSteelTools.SWORD, "深層鋼の剣")
            ...
            builder.add(RagiumItemsNew.FILLED_FLUID_CUBE, "液体キューブ（%s）")
            builder.add(RagiumItemsNew.FLUID_FILTER, "液体フィルタ")
            builder.add(RagiumItemsNew.FORGE_HAMMER, "鍛造ハンマー")
            builder.add(RagiumItemsNew.GIGANT_HAMMER, "ギガントハンマー")
            builder.add(RagiumItemsNew.GUIDE_BOOK, "ガイドブック")
            builder.add(RagiumItemsNew.ITEM_FILTER, "アイテムフィルタ")
            builder.add(RagiumItemsNew.RAGI_WRENCH, "らぎレンチ")
            builder.add(RagiumItemsNew.RAGIUM_SABER, "ラギウムセイバー")
            builder.add(RagiumItemsNew.STELLA_SABER, "S.T.E.L.L.A.セイバー")
            ...
            builder.add(RagiumItemsNew.CHOCOLATE_BREAD, "チョコパン")
            builder.add(RagiumItemsNew.CHOCOLATE_COOKIE, "チョコレートクッキー")
            builder.add(RagiumItemsNew.COOKED_MEAT_INGOT, "焼肉インゴット")
            builder.add(RagiumItemsNew.FLOUR, "小麦粉")
            builder.add(RagiumItemsNew.DOUGH, "生地")
            builder.add(RagiumItemsNew.MEAT_INGOT, "生肉インゴット")
            builder.add(RagiumItemsNew.MELON_PIE, "メロンパイ")
            builder.add(RagiumItemsNew.MINCED_MEAT, "ひき肉")
            builder.add(RagiumItemsNew.SWEET_BERRIES_CAKE_PIECE, "一切れのスイートベリーケーキ")
            ...
            builder.add(RagiumItemsNew.RAGI_TICKET, "らぎチケット")

            builder.add(RagiumItemsNew.PressMolds.GEAR, "プレス型（歯車）")
            builder.add(RagiumItemsNew.PressMolds.PIPE, "プレス型（パイプ）")
            builder.add(RagiumItemsNew.PressMolds.PLATE, "プレス型（板材）")
            builder.add(RagiumItemsNew.PressMolds.ROD, "プレス型（棒材）")
