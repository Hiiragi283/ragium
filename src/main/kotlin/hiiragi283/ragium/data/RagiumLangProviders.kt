...
object RagiumLangProviders {
    ...
    private class EnglishLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            // Items
            builder.add(RagiumItemsNew.STEEL_HELMET, "Steel Helmet")
            builder.add(RagiumItemsNew.STEEL_CHESTPLATE, "Steel Chestplate")
            builder.add(RagiumItemsNew.STEEL_LEGGINGS, "Steel Leggings")
            builder.add(RagiumItemsNew.STEEL_BOOTS, "Steel Boots")
            builder.add(RagiumItemsNew.STELLA_GOGGLE, "S.T.E.L.L.A. Goggles")
            builder.add(RagiumItemsNew.STELLA_JACKET, "S.T.E.L.L.A. Jacket")
            builder.add(RagiumItemsNew.STELLA_LEGGINGS, "S.T.E.L.L.A. Leggings")
            builder.add(RagiumItemsNew.STELLA_BOOTS, "S.T.E.L.L.A. Boots")
    ...
    private class JapaneseLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            // Items
            builder.add(RagiumItemsNew.STEEL_HELMET, "スチールのヘルメット")
            builder.add(RagiumItemsNew.STEEL_CHESTPLATE, "スチールのチェストプレート")
            builder.add(RagiumItemsNew.STEEL_LEGGINGS, "スチールのレギンス")
            builder.add(RagiumItemsNew.STEEL_BOOTS, "スチールのブーツ")
            builder.add(RagiumItemsNew.STELLA_GOGGLE, "S.T.E.L.L.A.ゴーグル")
            builder.add(RagiumItemsNew.STELLA_JACKET, "S.T.E.L.L.A.ジャケット")
            builder.add(RagiumItemsNew.STELLA_LEGGINGS, "S.T.E.L.L.A.レギンス")
            builder.add(RagiumItemsNew.STELLA_BOOTS, "S.T.E.L.L.A.ブーツ")
