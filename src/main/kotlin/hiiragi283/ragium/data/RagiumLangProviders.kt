...
object RagiumLangProviders {
    ...
    private class EnglishLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            builder.add(RagiumItems.Dynamites.BLAZING, "Fire Dynamite")
            ...
            builder.add(RagiumItems.Ingredients.BLAZING_CARBON_ELECTRODE, "Blazing Carbon Electrode")
            builder.add(RagiumItems.Ingredients.CARBON_ELECTRODE, "Carbon Electrode")
            builder.add(RagiumItems.Ingredients.CHARGED_CARBON_ELECTRODE, "Charged Carbon Electrode")
            builder.add(RagiumItems.Ingredients.CRIMSON_CRYSTAL, "Crimson Crystal")
            builder.add(RagiumItems.Ingredients.CRUDE_SILICON, "Crude Silicon")
            builder.add(RagiumItems.Ingredients.DEEPANT, "Deepant")
            builder.add(RagiumItems.Ingredients.ENGINE, "V8 Engine")
            builder.add(RagiumItems.Ingredients.ENGINEERING_PLASTIC_PLATE, "Engineering Plastic Plate")
            builder.add(RagiumItems.Ingredients.LASER_EMITTER, "Laser Emitter")
            builder.add(RagiumItems.Ingredients.LED, "L.E.D.")
            builder.add(RagiumItems.Ingredients.LUMINESCENCE_DUST, "Luminescence Dust")
            builder.add(RagiumItems.Ingredients.NUCLEAR_WASTE, "Nuclear Waste")
            builder.add(RagiumItems.Ingredients.OBSIDIAN_TEAR, "Obsidian Tear")
            builder.add(RagiumItems.Ingredients.PLASTIC_PLATE, "Plastic Plate")
            builder.add(RagiumItems.Ingredients.POLYMER_RESIN, "Polymer Resin")
            builder.add(RagiumItems.Ingredients.PROCESSOR_SOCKET, "Processor Socket")
            builder.add(RagiumItems.Ingredients.PULP, "Pulp")
            builder.add(RagiumItems.Ingredients.RAGI_ALLOY_COMPOUND, "Ragi-Alloy Compound")
            builder.add(RagiumItems.Ingredients.RAGI_CRYSTAL_PROCESSOR, "Ragi-Crystal Processor")
            builder.add(RagiumItems.Ingredients.REFINED_SILICON, "Refined Silicon")
            builder.add(RagiumItems.Ingredients.RESIDUAL_COKE, "Residual Coke")
            builder.add(RagiumItems.Ingredients.SILICON, "Silicon")
            builder.add(RagiumItems.Ingredients.SLAG, "Slag")
            builder.add(RagiumItems.Ingredients.SOAP_INGOT, "Soap Ingot")
            builder.add(RagiumItems.Ingredients.SOLAR_PANEL, "Solar Panel")
            builder.add(RagiumItems.Ingredients.STELLA_PLATE, "S.T.E.L.L.A. Plate")
            builder.add(RagiumItems.Ingredients.URANIUM_FUEL, "Uranium Fuel")
            builder.add(RagiumItems.Ingredients.PLUTONIUM_FUEL, "Plutonium Fuel")
            builder.add(RagiumItems.Ingredients.WARPED_CRYSTAL, "Warped Crystal")
            builder.add(RagiumItems.Ingredients.YELLOW_CAKE, "Yellow Cake")
            builder.add(RagiumItems.Ingredients.YELLOW_CAKE_PIECE, "A piece of Yellow Cake")
    ...
    private class JapaneseLang(output: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
        ...
        override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
            ...
            builder.add(RagiumItems.Ingredients.BLAZING_CARBON_ELECTRODE, "燃え盛る炭素電極")
            builder.add(RagiumItems.Ingredients.CARBON_ELECTRODE, "炭素電極")
            builder.add(RagiumItems.Ingredients.CHARGED_CARBON_ELECTRODE, "チャージされた炭素電極")
            builder.add(RagiumItems.Ingredients.CRIMSON_CRYSTAL, "深紅の結晶")
            builder.add(RagiumItems.Ingredients.CRUDE_SILICON, "粗製シリコン")
            builder.add(RagiumItems.Ingredients.DEEPANT, "ディーパント")
            builder.add(RagiumItems.Ingredients.ENGINE, "V8エンジン")
            builder.add(RagiumItems.Ingredients.ENGINEERING_PLASTIC_PLATE, "エンジニアリングプラスチック板")
            builder.add(RagiumItems.Ingredients.LASER_EMITTER, "レーザーエミッタ")
            builder.add(RagiumItems.Ingredients.LED, "L.E.D.")
            builder.add(RagiumItems.Ingredients.LUMINESCENCE_DUST, "ルミネッセンスダスト")
            builder.add(RagiumItems.Ingredients.NUCLEAR_WASTE, "核廃棄物")
            builder.add(RagiumItems.Ingredients.OBSIDIAN_TEAR, "黒曜石の涙")
            builder.add(RagiumItems.Ingredients.PLASTIC_PLATE, "プラスチック板")
            builder.add(RagiumItems.Ingredients.POLYMER_RESIN, "高分子樹脂")
            builder.add(RagiumItems.Ingredients.PROCESSOR_SOCKET, "プロセッサソケット")
            builder.add(RagiumItems.Ingredients.PULP, "パルプ")
            builder.add(RagiumItems.Ingredients.RAGI_ALLOY_COMPOUND, "ラギ合金混合物")
            builder.add(RagiumItems.Ingredients.RAGI_CRYSTAL_PROCESSOR, "ラギクリスタリルプロセッサ")
            builder.add(RagiumItems.Ingredients.REFINED_SILICON, "精製シリコン")
            builder.add(RagiumItems.Ingredients.RESIDUAL_COKE, "残渣油コークス")
            builder.add(RagiumItems.Ingredients.SILICON, "シリコン")
            builder.add(RagiumItems.Ingredients.SLAG, "スラグ")
            builder.add(RagiumItems.Ingredients.SOAP_INGOT, "石鹸インゴット")
            builder.add(RagiumItems.Ingredients.SOLAR_PANEL, "太陽光パネル")
            builder.add(RagiumItems.Ingredients.STELLA_PLATE, "S.T.E.L.L.A.板")
            builder.add(RagiumItems.Ingredients.URANIUM_FUEL, "ウラン燃料")
            builder.add(RagiumItems.Ingredients.PLUTONIUM_FUEL, "プルトニウム燃料")
            builder.add(RagiumItems.Ingredients.WARPED_CRYSTAL, "歪んだ結晶")
            builder.add(RagiumItems.Ingredients.YELLOW_CAKE, "イエローケーキ")
            builder.add(RagiumItems.Ingredients.YELLOW_CAKE_PIECE, "一切れのイエローケーキ")
