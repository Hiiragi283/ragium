...
class HTAssemblingRecipeBuilder : HTProgressRecipeBuilder(RagiumConst.ASSEMBLING) {
    companion object {
        @JvmStatic
    ...
    override fun createRecipe(): HTAssemblingRecipe = HTAssemblingRecipe(ingredients, result, progressData)
}
