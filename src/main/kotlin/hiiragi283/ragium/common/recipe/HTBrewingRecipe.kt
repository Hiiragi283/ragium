...
class HTBrewingRecipe : HTBasicCombineRecipe {
    val contents: PotionContents

    constructor(itemIngredients: Pair<HTItemIngredient, HTItemIngredient>, contents: PotionContents) : super(itemIngredients) {
        this.contents = contents
    }

    constructor(left: HTItemIngredient, right: HTItemIngredient, contents: PotionContents) : super(left, right) {
        this.contents = contents
    }
