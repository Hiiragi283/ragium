...
import hiiragi283.ragium.api.machine.entity.HTConsumerMachineEntityBase
...
class HTDrainMachineEntity(tier: HTMachineTier) :
    HTConsumerMachineEntityBase(RagiumMachineTypes.Consumer.DRAIN, tier),
