...
class HTDyedFluidType(private val color: DyeColor, properties: Properties) : HTFluidType(properties) {
    override fun getNameColor(stack: FluidStack): TextColor = TextColor.fromRgb(color.textColor)
