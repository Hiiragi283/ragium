...
object RagiumMetalItemFamilies {
    ...
    @JvmField
    val IRON: HTMetalItemFamily = HTMetalItemFamily.Builder()
    ...
    @JvmField
    val GOLD: HTMetalItemFamily = HTMetalItemFamily.Builder()
    ...
    @JvmField
    val COPPER: HTMetalItemFamily = HTMetalItemFamily.Builder()
    ...
    @JvmField
    val NETHERITE: HTMetalItemFamily = HTMetalItemFamily.Builder()
        .block(Items::NETHERITE_BLOCK, true)
        .ingot(Items::NETHERITE_INGOT, true)
        .build("netherite")

    @JvmField
    val RAGINITE: HTMetalItemFamily = HTMetalItemFamily.Builder()
    ...
    @JvmField
    val RAGI_ALLOY: HTMetalItemFamily = HTMetalItemFamily.Builder()
