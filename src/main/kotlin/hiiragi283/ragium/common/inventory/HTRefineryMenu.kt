...
class HTRefineryMenu(
...
) : HTDefinitionContainerMenu(RagiumMenuTypes.REFINERY, containerId, inventory, pos, definition) {
    ...
    init {
        // inputs
        addFluidSlot(0, HTSlotHelper.getSlotPosX(2), HTSlotHelper.getSlotPosY(0.5))
        // upgrades
        addUpgradeSlots()
        // outputs
        addFluidSlot(1, HTSlotHelper.getSlotPosX(5.5) - 4, HTSlotHelper.getSlotPosY(1) - 4, 24, 24)
        // player inventory
        addPlayerInv()
        // register property
