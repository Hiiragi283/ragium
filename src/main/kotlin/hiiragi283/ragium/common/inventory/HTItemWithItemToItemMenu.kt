...
class HTItemWithItemToItemMenu(
    ...
    companion object {
        ...
        private fun empty(
            ...
            slotPos: DoubleArray,
        ): HTItemWithItemToItemMenu = HTItemWithItemToItemMenu(
            menuType,
            containerId,
            inventory,
        ...
        @JvmStatic
        fun alloy(containerId: Int, inventory: Inventory, registryBuf: RegistryFriendlyByteBuf?): HTItemWithItemToItemMenu =
            empty(RagiumMenuTypes.ALLOY_SMELTER, containerId, inventory, registryBuf, ALLOY_POS)

        @JvmStatic
        fun press(containerId: Int, inventory: Inventory, registryBuf: RegistryFriendlyByteBuf?): HTItemWithItemToItemMenu =
