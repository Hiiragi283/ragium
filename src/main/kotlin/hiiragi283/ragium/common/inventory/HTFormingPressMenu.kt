...
class HTFormingPressMenu(
    containerId: Int,
    inventory: Inventory,
    pos: BlockPos,
    definition: HTMenuDefinition,
) : HTDefinitionContainerMenu(RagiumMenuTypes.FORMING_PRESS, containerId, inventory, pos, definition) {
    ...
    init {
        ...
        addSlot(1, HTSlotHelper.getSlotPosX(2), HTSlotHelper.getSlotPosY(2))
        // upgrades
        addUpgradeSlots()
        // outputs
