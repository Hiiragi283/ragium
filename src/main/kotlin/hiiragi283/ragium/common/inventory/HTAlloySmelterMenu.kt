...
class HTAlloySmelterMenu(
...
) : HTMachineMenu(RagiumMenuTypes.ALLOY_SMELTER, containerId, inventory, pos, definition) {
    ...
    init {
        // inputs
        addSlot(definition.getInputSlot(0).createContainerSlot(1.5, 0.0))
        addSlot(definition.getInputSlot(1).createContainerSlot(2.5, 0.0))
        // upgrades
        addUpgradeSlots()
        // outputs
