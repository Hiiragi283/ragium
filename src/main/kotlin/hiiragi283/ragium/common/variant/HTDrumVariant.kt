...
enum class HTDrumVariant(private val enPattern: String, private val jaPattern: String) : HTVariantKey.WithBE<HTDrumBlockEntity> {
    ...
    val entityHolder: HTDeferredEntityType<HTDrumMinecart> by lazy { RagiumEntityTypes.DRUMS[this]!! }
