...
class HTPyrolyzerBlockEntity(pos: BlockPos, state: BlockState) :
    ...
    inner class RecipeComponent : HTEnergizedRecipeComponent.Cached<HTPyrolyzingRecipe>(RagiumRecipeTypes.PYROLYZING, this) {
        ...
        override fun canProgressRecipe(level: ServerLevel, input: HTViewRecipeInput, recipe: HTPyrolyzingRecipe): Boolean {
            val access: RegistryAccess = level.registryAccess()
