...
class HTMelterBlockEntity(pos: BlockPos, state: BlockState) :
    ...
    override fun createRecipeComponent() = object : HTEnergizedRecipeComponent.Cached<HTMeltingRecipe>(RagiumRecipeTypes.MELTING, this) {
        ...
        override fun canProgressRecipe(level: ServerLevel, input: HTViewRecipeInput, recipe: HTMeltingRecipe): Boolean =
