...
class HTFurnaceBlockEntity(pos: BlockPos, state: BlockState) :
    ...
    private inner class SmeltingComponent : HTRecipeComponent<SingleRecipeInput, AbstractCookingRecipe>(this) {
        ...
        override fun getMaxProgress(recipe: AbstractCookingRecipe): Int = this@HTFurnaceBlockEntity.updateAndGetProgress(recipe.cookingTime)
