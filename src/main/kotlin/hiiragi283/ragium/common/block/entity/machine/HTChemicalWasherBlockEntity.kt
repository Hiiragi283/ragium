...
class HTChemicalWasherBlockEntity(pos: BlockPos, state: BlockState) :
    ...
    override fun getLookup(): HTRecipeLookup<HTItemAndFluidRecipeInput, out HTItemOrFluidRecipe> = RagiumRecipeLookups.CHEMICAL_WASHING

    override fun playSound() {
        playSound(SoundEvents.LAVA_POP)
    }

    override fun getConfig(): HTMachineConfig = RagiumConfig.COMMON.machine.chemicalWasher
}
