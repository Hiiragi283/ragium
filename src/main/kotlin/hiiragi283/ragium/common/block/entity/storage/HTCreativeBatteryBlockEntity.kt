...
class HTCreativeBatteryBlockEntity(pos: BlockPos, state: BlockState) : HTBatteryBlockEntity<HTInfiniteEnergyHandler>(RagiumBlockEntityTypes.CREATIVE_BATTERY, pos, state) {
