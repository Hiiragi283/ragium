...
class HTExtractorBlockEntity(pos: BlockPos, state: BlockState) :
    ...
    private val recipeCache: HTMachineRecipeCache<HTExtractorRecipe> = HTMachineRecipeCache(HTRecipeTypes.EXTRACTOR)
    ...
    override fun createMenu(containerId: Int, playerInventory: Inventory, player: Player): AbstractContainerMenu? =
        HTExtractorMenu(containerId, playerInventory, blockPos, inputSlot, outputSlot)
