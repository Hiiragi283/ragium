...
import hiiragi283.ragium.common.screen.HTAssemblyLineScreenHandler
...
class HTAssemblyLineBlockEntity(pos: BlockPos, state: BlockState) :
    HTRecipeProcessorBlockEntityBase(RagiumBlockEntityTypes.ASSEMBLY_LINE, pos, state),
    HTMultiblockProvider.Machine {
    override var machineKey: HTMachineKey = RagiumMachineKeys.ASSEMBLY_LINE
    ...
    override fun createMenu(syncId: Int, playerInventory: PlayerInventory, player: PlayerEntity): ScreenHandler? =
        HTAssemblyLineScreenHandler(syncId, playerInventory, createContext())
