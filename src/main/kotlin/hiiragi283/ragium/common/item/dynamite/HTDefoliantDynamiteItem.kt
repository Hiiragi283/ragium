...
import hiiragi283.ragium.common.entity.HTDefoliantDynamite
...
class HTDefoliantDynamiteItem(properties: Properties) : HTThrowableItem(properties) {
    ...
    override fun throwProjectile(level: Level, player: Player, stack: ItemStack): Projectile =
        HTDynamite.withItem(level, player, stack, ::HTDefoliantDynamite)
}
