...
class HTMixerRecipeCategory(guiHelper: IGuiHelper) : HTMachineRecipeCategory<HTMixerRecipe>(guiHelper, HTMachineType.MIXER, 3.5) {
    override fun getRecipeType(): RecipeType<RecipeHolder<HTMixerRecipe>> = RagiumJEIRecipeTypes.MIXER

    override fun setRecipe(builder: IRecipeLayoutBuilder, recipe: HTMixerRecipe) {
        // Item Input
        builder
