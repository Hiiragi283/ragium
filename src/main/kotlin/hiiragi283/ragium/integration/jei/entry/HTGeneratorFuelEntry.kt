...
data class HTGeneratorFuelEntry(val machine: HTMachineType, val fuelTag: TagKey<Fluid>, val amount: Int) {
    companion object {
        @JvmField
        val CODEC: Codec<HTGeneratorFuelEntry> = RecordCodecBuilder.create { instance ->
            instance
                .group(
                    HTMachineType.FIELD_CODEC.forGetter(HTGeneratorFuelEntry::machine),
