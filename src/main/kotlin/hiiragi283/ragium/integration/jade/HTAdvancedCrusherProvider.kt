...
object HTAdvancedCrusherProvider : HTProgressDataProvider() {
    ...
    override fun streamData(accessor: BlockAccessor): HTProgressData? {
        val crusher: HTAdvancedCrusherBlockEntity = accessor.blockEntity as? HTAdvancedCrusherBlockEntity ?: return null
    ...
    override fun getUid(): ResourceLocation = RagiumAPI.id("advanced_crusher")
}
