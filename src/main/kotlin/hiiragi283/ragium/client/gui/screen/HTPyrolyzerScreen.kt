...
class HTPyrolyzerScreen(menu: HTPyrolyzerContainerMenu, inventory: Inventory, title: Component) :
    HTProcessorScreen<HTPyrolyzerBlockEntity, HTPyrolyzerContainerMenu>(menu, inventory, title) {
    override fun init() {
        super.init()
