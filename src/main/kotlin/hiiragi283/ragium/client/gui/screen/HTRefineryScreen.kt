...
class HTRefineryScreen(menu: HTBlockEntityContainerMenu<HTRefineryBlockEntity>, inventory: Inventory, title: Component) :
    ...
    override fun init() {
        super.init()
        fluidWidget =
            addRenderableWidget(createFluidWidget(0, HTSlotHelper.getSlotPosX(2), HTSlotHelper.getSlotPosY(0)))
        fluidWidget1 =
            addRenderableWidget(createFluidWidget(1, HTSlotHelper.getSlotPosX(6), HTSlotHelper.getSlotPosY(0)))
    }
