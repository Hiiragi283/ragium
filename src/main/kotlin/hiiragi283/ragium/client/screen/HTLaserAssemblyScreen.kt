...
import hiiragi283.ragium.common.inventory.HTLaserAssemblyMenu
...
@OnlyIn(Dist.CLIENT)
class HTLaserAssemblyScreen(menu: HTLaserAssemblyMenu, inventory: Inventory, title: Component) :
    HTMachineScreen<HTLaserAssemblyMenu>(menu, inventory, title) {
