...
@OnlyIn(Dist.CLIENT)
class HTInfuserContainer(menu: HTInfuserContainerMenu, inventory: Inventory, title: Component) :
    HTMachineContainerScreen<HTInfuserContainerMenu>(menu, inventory, title) {
