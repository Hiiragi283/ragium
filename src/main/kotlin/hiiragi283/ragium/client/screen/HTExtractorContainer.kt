...
@OnlyIn(Dist.CLIENT)
class HTExtractorContainer(menu: HTExtractorContainerMenu, inventory: Inventory, title: Component) :
    HTMachineContainerScreen<HTExtractorContainerMenu>(menu, inventory, title) {
