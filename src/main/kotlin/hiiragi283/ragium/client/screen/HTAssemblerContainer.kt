...
@OnlyIn(Dist.CLIENT)
class HTAssemblerContainer(menu: HTAssemblerContainerMenu, inventory: Inventory, title: Component) :
    HTMachineContainerScreen<HTAssemblerContainerMenu>(menu, inventory, title) {
