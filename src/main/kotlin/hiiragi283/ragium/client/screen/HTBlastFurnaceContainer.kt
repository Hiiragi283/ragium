...
@OnlyIn(Dist.CLIENT)
class HTBlastFurnaceContainer(menu: HTBlastFurnaceContainerMenu, inventory: Inventory, title: Component) :
    HTMachineContainerScreen<HTBlastFurnaceContainerMenu>(menu, inventory, title) {
