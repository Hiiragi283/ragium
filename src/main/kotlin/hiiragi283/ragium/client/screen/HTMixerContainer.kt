...
@OnlyIn(Dist.CLIENT)
class HTMixerContainer(menu: HTMixerContainerMenu, inventory: Inventory, title: Component) :
    HTMachineContainerScreen<HTMixerContainerMenu>(menu, inventory, title) {
