...
data object RagiumEnglishLangProvider : HTLangProvider.English(RagiumAPI.MOD_ID) {
    override fun addTranslations() {
        ...
        // Fluid
        add(RagiumFluids.AIR, "Air")
        add(RagiumFluids.HYDROGEN, "Hydrogen")
        add(RagiumFluids.CARBON_DIOXIDE, "Carbon Dioxide")
        add(RagiumFluids.NITROGEN, "Nitrogen")
        add(RagiumFluids.AMMONIA, "Ammonia")
        add(RagiumFluids.OXYGEN, "Oxygen")

        add(RagiumFluids.NITRIC_ACID, "Nitric Acid")
        add(RagiumFluids.MIXTURE_ACID, "Mixture Acid")
        add(RagiumFluids.SULFURIC_ACID, "Sulfuric Acid")

        add(RagiumFluids.CREOSOTE, "Creosote")
        add(RagiumFluids.SYNTHETIC_GAS, "Synthetic Gas")
        add(RagiumFluids.SYNTHETIC_OIL, "Synthetic Oil")

        add(RagiumFluids.CRUDE_OIL, "Crude Oil")
        add(RagiumFluids.NAPHTHA, "Naphtha")
        add(RagiumFluids.RESIDUE_OIL, "Residue Oil")

        add(RagiumFluids.METHANE, "Methane")
        add(RagiumFluids.ETHYLENE, "Ethylene")
        add(RagiumFluids.BUTADIENE, "Butadiene")

        add(RagiumFluids.METHANOL, "Methanol")
        add(RagiumFluids.ETHANOL, "Ethanol")

        add(RagiumFluids.FUEL, "Fuel")
        add(RagiumFluids.LUBRICANT, "Lubricant")

        add(RagiumFluids.SUNFLOWER_OIL, "Sunflower Oil")
        add(RagiumFluids.BIOFUEL, "Biofuel")

        add(RagiumFluids.MOLTEN_RAGINITE, "Destabilized Raginite")
        add(RagiumFluids.MOLTEN_STAINLESS_STEEL, "Molten Stainless Steel")

        add(RagiumFluids.COOLANT, "Coolant")
        add(RagiumFluids.RAGI_MATTER, "Ragi-Matter")
