 ...
 */
abstract class HTMultiItemRecipe(group: String, val itemInputs: List<HTItemIngredient>, itemResult: HTItemOutput) :
    ...
    class Serializer<T : HTMultiItemRecipe>(private val factory: (String, List<HTItemIngredient>, HTItemOutput) -> T) :
        RecipeSerializer<T> {
