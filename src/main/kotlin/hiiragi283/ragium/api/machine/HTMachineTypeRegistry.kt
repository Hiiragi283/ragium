...
object HTMachineTypeRegistry {
    ...
    val CODEC: Codec<HTMachineType> =
        Identifier.CODEC.xmap(HTMachineTypeRegistry::getOrThrow, HTMachineType::id)

    @JvmField
    val GENERATOR_CODEC: Codec<HTMachineType.Generator> =
        Identifier.CODEC.xmap(HTMachineTypeRegistry::getGeneratorOrThrow, HTMachineType::id)

    @JvmField
    val PROCESSOR_CODEC: Codec<HTMachineType.Processor> =
        Identifier.CODEC.xmap(HTMachineTypeRegistry::getProcessorOrThrow, HTMachineType::id)

    @JvmField
    val PACKET_CODEC: PacketCodec<ByteBuf, HTMachineType> =
        Identifier.PACKET_CODEC.xmap(HTMachineTypeRegistry::getOrThrow, HTMachineType::id)

    @JvmField
    val GENERATOR_PACKET_CODEC: PacketCodec<ByteBuf, HTMachineType.Generator> =
        Identifier.PACKET_CODEC.xmap(HTMachineTypeRegistry::getGeneratorOrThrow, HTMachineType::id)

    @JvmField
    val PROCESSOR_PACKET_CODEC: PacketCodec<ByteBuf, HTMachineType.Processor> =
        Identifier.PACKET_CODEC.xmap(HTMachineTypeRegistry::getProcessorOrThrow, HTMachineType::id)
    ...
    fun init() {
        ...
        FabricLoader.getInstance().invokeEntrypoints(
            ...
            initializer.registerType(HTMachineTypeRegistry::addMachine)
        }
