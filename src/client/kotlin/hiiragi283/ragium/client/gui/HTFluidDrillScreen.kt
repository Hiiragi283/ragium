...
class HTFluidDrillScreen(handler: HTFluidDrillScreenHandler, inventory: PlayerInventory, title: Text) :
    HTMachineScreenBase<HTFluidDrillScreenHandler>(handler, inventory, title) {
    companion object {
        @JvmField
        val TEXTURE: Identifier = RagiumAPI.id("textures/gui/fluid_drill.png")
    }
    ...
    override fun drawMouseoverTooltip(context: DrawContext, x: Int, y: Int) {
        ...
        drawFluidTooltip(context, fluidCache[0], amountCache[0], 6, 2, x, y)
    ...
    override fun drawBackground(
        ...
        drawFluid(context, fluidCache[0], 6, 2)
