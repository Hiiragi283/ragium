            ...
            .create(
                ...
                menu.trackedSlots
                    .mapIndexedNotNull { index: Int, (slot: HTSyncableSlot, syncType: HTSyncType) ->
                        ...
                        val payload: HTSyncablePayload =
                            slot.createPayload(access, changeType) ?: return@mapIndexedNotNull null
                        index to payload
                    }
                    .onEach { (index: Int, payload: HTSyncablePayload) ->
                        RagiumAPI.LOGGER.debug("Added sync value index: {}, payload: {}", index, payload)
                    }
                    .toMap()
